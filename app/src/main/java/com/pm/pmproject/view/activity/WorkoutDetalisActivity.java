...
//                @Override
//                public boolean onLongClick(View v) {
//                    View popupView = LayoutInflater.from(WorkoutDetalisActivity.this)
//                            .inflate(R.layout.edit_popup, null);
//
//                    Button button_ok = popupView.findViewById(R.id.button_ok);
//                    Button button_delete = popupView.findViewById(R.id.button_delete);
//                    TextView attribute_name = popupView.findViewById(R.id.attribute_name);
//                    EditText attribute_value = popupView.findViewById(R.id.attribute_value);
//
//                    attribute_name.setText(attributeTraining.getAttribute().getType());
//                    attribute_value.setText(attributeTraining.getValue());
//
...
//                            daoSession.getAttributeTrainingDao().delete(attributeTraining);
//                            //TODO refresh
//                            populateView();
//                            popupWindow.dismiss();
//                        }
...
//                        @Override
//                        public void onClick(View v) {
//                            attributeTraining.setValue(attribute_value.getText().toString());
//                            daoSession.getAttributeTrainingDao().update(attributeTraining);
//                            //TODO refresh
//                            Intent intent = getIntent();
